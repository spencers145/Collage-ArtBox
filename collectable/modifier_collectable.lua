SMODS.Consumable({
  ...
  draw = function(self, card, layer)
    if (layer == 'card' or layer == 'both') and card.sprite_face == 'front' and card.ability.extra.shader then
      card.children.floating_sprite:draw_shader(card.ability.extra.shader, nil, card.ARGS.send_to_shader)
    end
  end
})
